...
/*   Updated: 2024/12/04 01:31:40 by mehmyilm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Account::Account(int initial_deposit)
{
	...
	t::_displayTimestamp();
	std::cout<<"index:"<<_nbAccounts++<<";ammount:"
...
{
	t::_displayTimestamp();
	std::cout<<"index:"<<_accountIndex<<";ammount:"
...
{
	t::_displayTimestamp();
	std::cout<<"accounts:"<<t::getNbAccounts()+1
...
{
	t::_displayTimestamp();
	std::cout<<"index:"<<t::_accountIndex<<";ammount:"
